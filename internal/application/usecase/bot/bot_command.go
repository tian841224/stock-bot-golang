...
type BotCommandUsecase interface {
	...
	SubscribeStock(ctx context.Context, userID uint, symbol string) (string, error)
	UnsubscribeStock(ctx context.Context, userID uint, symbol string) (string, error)
	SubscribedItems(ctx context.Context, userID uint, item valueobject.SubscriptionType) (string, error)
	UnsubscribedItems(ctx context.Context, userID uint, item valueobject.SubscriptionType) (string, error)
	GetSubscribed(ctx context.Context, userID uint) (string, error)
...
type botCommandUsecase struct {
	...
	userSubscriptionUsecase user.UserSubscriptionUsecase
...
func (u *botCommandUsecase) GetStockPerformanceChart(ctx context.Context, symbol string) (*dto.ChartAsset, error) {
	...
	if chart == nil {
		return nil, errors.New("取得績效圖表失敗")
	}
...
func (u *botCommandUsecase) GetStockRevenueChart(ctx context.Context, symbol string) (*dto.ChartAsset, error) {
	...
	if chart == nil {
		return nil, errors.New("取得月營收圖表失敗")
	}
...
func (u *botCommandUsecase) GetHistoricalCandlesChart(ctx context.Context, symbol string) (*dto.ChartAsset, error) {
	...
	if chart == nil {
		return nil, errors.New("取得歷史K線圖失敗")
	}
...
func (u *botCommandUsecase) SubscribeStock(ctx context.Context, userID uint, symbol string) (string, error) {
	result, err := u.userSubscriptionUsecase.AddUserSubscriptionStock(ctx, userID, symbol)
	if err != nil {
		return "", err
	}
	return result, nil
...
func (u *botCommandUsecase) UnsubscribeStock(ctx context.Context, userID uint, symbol string) (string, error) {
	result, err := u.userSubscriptionUsecase.DeleteUserSubscriptionStock(ctx, userID, symbol)
	if err != nil {
		return "", err
	}
	return result, nil
...
func (u *botCommandUsecase) SubscribedItems(ctx context.Context, userID uint, item valueobject.SubscriptionType) (string, error) {
	result, err := u.userSubscriptionUsecase.AddUserSubscriptionItem(ctx, userID, item)
	if err != nil {
		return "", err
	}
	return result, nil
...
func (u *botCommandUsecase) UnsubscribedItems(ctx context.Context, userID uint, item valueobject.SubscriptionType) (string, error) {
	result, err := u.userSubscriptionUsecase.DeleteUserSubscriptionItem(ctx, userID, item)
	if err != nil {
		return "", err
	}
	return result, nil
...
func (u *botCommandUsecase) GetSubscribed(ctx context.Context, userID uint) (string, error) {
	stocks, err := u.userSubscriptionUsecase.GetUserSubscriptionStockList(ctx, userID)
	if err != nil {
		return "", err
	}
	items, err := u.userSubscriptionUsecase.GetUserSubscriptionItemList(ctx, userID)
	if err != nil {
		return "", err
	}
	return u.formatterPort.FormatSubscribed(stocks, items), nil
}
