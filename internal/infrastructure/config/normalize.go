...
func (c *Config) normalize() {
	...
	c.TELEGRAM_ADMIN_CHAT_ID = normalizeString(c.TELEGRAM_ADMIN_CHAT_ID)
	c.DB_NAME = normalizeString(c.DB_NAME)
	c.SCHEDULER_STOCK_SPEC = normalizeString(c.SCHEDULER_STOCK_SPEC)
	c.CHANNEL_ACCESS_TOKEN = normalizeString(c.CHANNEL_ACCESS_TOKEN)
	c.CHANNEL_SECRET = normalizeString(c.CHANNEL_SECRET)
	c.SCHEDULER_TIMEZONE = normalizeString(c.SCHEDULER_TIMEZONE)
