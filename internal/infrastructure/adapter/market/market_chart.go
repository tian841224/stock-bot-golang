...
func NewMarketChartGateway(marketChartPort port.MarketChartPort, marketDataPort port.MarketDataPort, validationPort port.ValidationPort, fugleAPI *fugle.FugleAPI) *marketChartGateway {
