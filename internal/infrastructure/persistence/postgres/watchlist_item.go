...
type WatchlistItemRepository interface {
	...
	GetSymbolsByWatchlistID(watchlistID uint) ([]*models.StockSymbol, error)
...
func (r *watchlistItemRepository) GetSymbolsByWatchlistID(watchlistID uint) ([]*models.StockSymbol, error) {
